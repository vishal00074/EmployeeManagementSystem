...
<div class="content">
    ...
    <div class="card">
        <div class ="row s-filter">
            <div class="col-md-3">
               <h5 class="ml-2 mb-0">
                  <a href="{{ url('admin/humanResource/candidate/add') }}"><button type="button" class="btn btn-primary btn-sm" ><i class="icon-plus-circle2 mr-2"></i> Add</button></a>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var dataTable = $('.get_Customer_details').DataTable({
            ...
            "order": [[ 0, "desc" ]],
            ajax: {
                url: "{{ url('admin/humanResource/candidate') }}",
                data: function (d) {
                        d.Status = $('#Status').val(),
        ...
        $('body').on('click', '.delete-customer', function () {
            ...
            swalInit.fire({
                ...
                if(result.value) {
                    $.ajax({
                        type:'Delete',
                        url:'{{ url('admin/candidate_delete') }}/'+id,
