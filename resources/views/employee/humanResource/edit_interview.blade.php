    ...
    <div class="card">
        <div class="card-header header-elements-inline">
        	<div class="col-sm-6 mb-1" align="left">
			    <h6 class="card-title"><b>Update Interview Details</b></h6>
            </div>
        ...
        <div class="card-body"> 
            <div class="row">
                <div class="col-md-12">
                    <form  action="{{ route('interview.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
...
<!-- Add other dropdowns with similar code -->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" name="interview_date_time" value="{{ $data->interview_date_time}}"> 
                            ...
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="additional_notes" value="{{ $data->additional_notes}}"> 
