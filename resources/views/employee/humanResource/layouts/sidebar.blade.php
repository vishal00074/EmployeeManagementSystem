                ...
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        ...
                        <a href="{{url('admin/humanResource')}}" class="nav-link ">
                     ...
                     <li class="nav-item">
                        ...
                        <a href="{{url('admin/humanResource/candidate')}}" class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{url('admin/humanResource/interview')}}" class="nav-link">
