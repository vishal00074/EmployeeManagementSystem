        ...
        <div class="wrap">
            <div class="form-box p-4 p-md-5">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-6 mb-4" align="right">
                        <button type="button" class="btn btn-success btn-sm">
                            <a href="{{ url('employee/hr/job') }}" class="text-white"> <i class="icon-circle-left2 mr-1"></i> Back</a>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('hr.humanResource.save') }}" method="post" class="canidate" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Company Name</label>
                                            <input type="text" class="form-control" name="company_name" id="company_name" value="Xpertidea IT Solutions Pvt. Ltd." readonly>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="job_skill" id="job_skill" data-role="tagsinput">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Budget</label>
                                            <input type="text" class="form-control" name="job_budget" id="job_budget">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" id="job_description" name="job_description"></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="shift" name="shift">
                                                ...
                                                <option value="{{ $item->id }}">{{ $item->type }} Timing: {{ $item->timing }}</option>
                                                @endforeach
                                            </select>
                                            @if ($errors->has('shift'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control" id="key_responsibilities" name="key_responsibilities"></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" class="form-control" name="email" id="email" value="hr@Xpertidea.com">
                                            @if ($errors->has('email'))
