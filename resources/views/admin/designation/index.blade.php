...
<div class="content">
    ...
    <div class="card">
        <div class ="row s-filter">
            <div class="col-md-3">
               <h5 class="ml-2 mb-0">
                  <a href="{{ url('admin/designation/add') }}"><button type="button" class="btn btn-primary btn-sm" ><i class="icon-plus-circle2 mr-2"></i> Add</button></a>
               </h5>
            </div>
        ...
        $('body').on('click', '.delete-customer', function () {
            ...
            swalInit.fire({
                ...
                if(result.value) {
                    $.ajax({
                        type:'Delete',
                        url:'{{ url('admin/designation_delete') }}/'+id,
