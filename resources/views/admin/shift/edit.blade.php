                    ...
                    <form action="{{ route('shift.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Time IN</label>
                                    <input type="time" class="form-control" name="time_in"  value="{{ $data->time_in ?? '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="time_out" value="{{ $data->time_out ?? '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="less_hours" value="{{ $data->less_hours ?? '' }}">
