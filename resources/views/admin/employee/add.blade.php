...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('employee.save') }}" method="post" enctype="multipart/form-data" class="employee">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="permanant_address"></textarea>
