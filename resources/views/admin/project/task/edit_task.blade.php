    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            ...
            <div class="col-sm-6 mb-1" align="right">
                <a class="btn btn-success" href="{{ url('admin/project/task-view/') }}/{{ $task->project_id }}">Back</a>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                <form name="task" id="task" action="{{ route('task.assign.edit', ['id' => $id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="employee_id"   class="form-control @error('employee_id') is-invalid @enderror" id="employee_id" disabled>
                                    <option value="{{ $task->employee_id }}">{{ $employee->name }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ $task->title }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control @error('billing_hours') is-invalid @enderror" id="billing_hours" value="{{ $task->billing_hours }}" name="billing_hours">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control @error('non_billing_hours') is-invalid @enderror" id="non_billing_hours" name="non_billing_hours" value="{{ $task->non_billing_hours }}">
                            </div>
                        </div>
