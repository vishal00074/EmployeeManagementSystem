        ...
        <div class="sidebar-content">
            ...
            <div class="card card-sidebar-mobile" id="sidebar-mobile">
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item">
                        <a href="{{url('admin/leave')}}" class="nav-link {{Request::segment(1)=='home' ? 'active' : ''}}">
                        <i class="bi-calendar2-minus-fill"></i>
                            <span>Leave</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{url('admin/leave_type')}}" class="nav-link {{Request::segment(1)=='home' ? 'active' : ''}}">
                    ...
                    <li class="nav-item">
                        <a href="{{url('admin/leave/assign/')}}" class="nav-link {{Request::segment(1)=='home' ? 'active' : ''}}">
                    ...
                    <li class="nav-item">
                        <a href="{{url('admin/leave/assign/history')}}" class="nav-link {{Request::segment(1)=='home' ? 'active' : ''}}">
                        <i class="bi-calendar3-event-fill"></i>
                            <span>Assigned Leave History</span>
                        </a>
                    </li>
                <!-- <li class="nav-item">
