...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-body"> 
            <div class="row">
                <div class="col-md-6">
                    <form action="{{ url('admin/faqlist2/update', $data->id) }}" method="post" enctype="multipart/form-data"> 
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="faqtitle" value="{{$data->faqtitle}}"> 
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>FaqDescription</label>
                                    <input type="text" class="form-control" name="faqdescription" value="{{$data->faqdescription}}"> 
                                </div>
                            </div>
