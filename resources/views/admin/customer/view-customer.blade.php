...
<div class="content">
    ...
    <div class="card">
        <div class="row s-filter">
            <div class="col-md-3">
               <h5 class="ml-2 mb-0">
                   <a href="{{ url('/admin/slide_add')}}"><button type="button" class="btn btn-primary btn-sm" ><i class="icon-plus-circle2 mr-2"></i> Add</button></a>
               </h5>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var dataTable = $('.get_Customer_details').DataTable({
            ...
            ajax: "{{ url('/admin/view_customer',$data->id)}}",
            columns: [
                {data: 'name', name: 'name'},
