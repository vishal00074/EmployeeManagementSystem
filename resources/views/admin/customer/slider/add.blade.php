...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="AddVendorDetails" name="AddVendorDetails" action="{{ url('/admin/intro_sliders/add') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" class="form-control" id="" class="form-control" name="title">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" class="form-control" name="image_title">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Image Title Fr</label>
                                    <input type="text" class="form-control" id="" class="form-control" name="image_title_fr">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="" class="form-control" name="description"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Description Fr</label>
                                    <textarea type="text" class="form-control" id="" class="form-control" name="description_fr"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        if ($(".AddVendorDetails").length > 0) {
            $(".AddVendorDetails").validate({
                rules: {
                    title: "required",
                    image: "required",
