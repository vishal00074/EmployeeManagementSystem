    ...
    <div class="card">
        <div class="row s-filter">
            ...
            <div class="col-md-7" align="right">
                <a href="{{ url('admin/employee/report/detail') }}"><button type="button" class="btn btn-primary btn-sm">Back</button></a>
            </div>
        </div>
        ...
        <table class="table get_Customer_details">
            ...
            <tbody>
                ...
                <td>{{ $item->message }}</td>
                <td><a href="{{ url($item->documents) }}" class="btn btn-success">url</a></td>
                @endforeach
            </tbody>
        </table>
    </div>
