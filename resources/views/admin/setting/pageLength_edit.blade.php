    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            ...
            <div class="col-sm-6 mb-1" align="right">
                <a class="btn btn-success" href="{{ url('admin/setting/pagelength') }}">Back</a>
            </div>
        </div>
        ...
        <div class="card-body"> 
            <div class="row">
                <div class="col-md-12">
                   <form action="{{ route('pagelength.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
