            ...
            <div class="card card-sidebar-mobile" id="sidebar-mobile">
                ...
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{url('admin/attendence')}}" class="nav-link {{Request::segment(1)=='home' ? 'active' : ''}}">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{url('admin/attendance/pdf/records')}}" class="nav-link {{Request::segment(1)=='home' ? 'active' : ''}}">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{url('admin/attendance/report')}}" class="nav-link {{Request::segment(1)=='home' ? 'active' : ''}}">
